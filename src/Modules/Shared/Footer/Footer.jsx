                                        ...
                                        <footer className="footer bg-light">
                                            <div className="container-fluid d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-1 container-p-x py-3">
                                                ...
                                                <div>
                                                    ...
                                                    <a href="javascript:void(0)" className="footer-link me-4">
                                                        Help
                                                    </a>
                                                    <a href="javascript:void(0)" className="footer-link me-4">
                                                        Contact
                                                    ...
                                                    <div className="dropdown dropup footer-link me-3">
                                                        ...
                                                        <div className="dropdown-menu dropdown-menu-end">
                                                            <a className="dropdown-item" href="javascript:void(0);">
                                                                <i className="bx bx-dollar" /> USD
                                                            </a>
                                                            <a className="dropdown-item" href="javascript:void(0);">
                                                                <i className="bx bx-euro" /> Euro
                                                            </a>
                                                            <a className="dropdown-item" href="javascript:void(0);">
                                                                <i className="bx bx-pound" /> Pound
                                                            </a>
                                                            <div className="dropdown-divider" />
                                                            <a className="dropdown-item" href="javascript:void(0);">
                                                                <i className="bx bx-bitcoin" /> Bitcoin
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <a
